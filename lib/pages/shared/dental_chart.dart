            ...
            child: Row(
              ...
              children: [
                Checkbox(
                  ...
                  onChanged: (checked) => setState(() => showPermanent = checked ?? false),
                  content: Text(txt("showPermanent")),
                ),
                Checkbox(
                  checked: showPrimary,
                  onChanged: (checked) => setState(() => showPrimary = checked ?? false),
                  content: Text(txt("showPrimary")),
                ),
              ],
            ),
          ),
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Text(isoToTextualNotation(openTooth), style: const TextStyle(fontSize: 12)),
                        IconButton(
                    ...
                    FilledButton(
                        ...
                        onPressed: () {
                          setState(() {
                            pages.openPatient.teeth[openTooth] = _noteController.text;
                            openTooth = "";
                          });
                        })
                  ],
